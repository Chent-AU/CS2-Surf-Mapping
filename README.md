...
*Note, if your curved ramp contains a long straight segment with curved section at both or either end, ensure the long straight clips have the `physics type` set to `mesh`.*
